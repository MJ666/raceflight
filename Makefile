...
F4_TARGETS       = REVO REVO_OPBL SPARKY2 SPARKY2_OPBL REVONANO REVONANO_OPBL ALIENFLIGHTF4 BLUEJAYF4 VRCORE QUANTON QUANTON_OPBL AQ32_V2 YOUPIF4 YOUPIF4_OPBL AQM4

F405_TARGETS     = REVO REVO_OPBL SPARKY2 SPARKY2_OPBL ALIENFLIGHTF4 BLUEJAYF4 VRCORE QUANTON AQ32_V2 YOUPIF4 YOUPIF4_OPBL AQM4
F405_TARGETS_16  = QUANTON QUANTON_OPBL
F411_TARGETS     = REVONANO REVONANO_OPBL

SDCARD_TARGETS   = ALIENFLIGHTF4 BLUEJAYF4 SPRACINGF3MINI AQ32_V2 AQM4
...
ifeq ($(TARGET),$(filter $(TARGET),REVO REVO_OPBL REVONANO REVONANO_OPBL ALIENFLIGHTF4 BLUEJAYF4 VRCORE AQ32_V2 SPARKY2 SPARKY2_OPBL YOUPIF4 YOUPIF4_OPBL AQM4))
OPTIMIZE	 = -O2
else
OPTIMIZE	 = -Os
endif
