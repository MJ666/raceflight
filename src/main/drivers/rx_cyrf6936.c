...
#include "rx_cyrf6936.h"
#include "rx_cyrf6936_regs.h"
// #include "util.h"
// #include "comm.h"
// #include "rcc.h"
// #include "aq_timer.h"
...
uint8_t cyrfInit(void) {
    ...
    GPIO_InitStructure.GPIO_Pin = CYRF_RST_PIN;
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
    GPIO_Init(CYRF_RST_PORT, &GPIO_InitStructure);
    digitalHi(CYRF_RST_PORT, CYRF_RST_PIN);
    delayMicros(100);
    digitalLo(CYRF_RST_PORT, CYRF_RST_PIN);
    delayMicros(100);
#endif
